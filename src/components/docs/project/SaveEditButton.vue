<template>
  <div>
    ...
    <span class="fkr-commands" v-if="!active">
      <a class="fkr-edit" @click="onclick(2)" target="_self"></a>
      &nbsp;&nbsp;
      <a class="fkr-delete" @click="onclick(3)" target="_self"></a>
    </span>
    <span class="fkr-commands" v-if="active">
      <a class="fkr-save" @click="onclick(1)" target="_self"></a>
      &nbsp;&nbsp;
      <a class="fkr-cancel" @click="onclick(4)" target="_self"></a>
    </span>
  </div>
</template>
<script lang="ts">
...
export default class SaveEditButton extends Vue {
  ...
  public cancelImgUrl: string = `${_spPageContextInfo.webAbsoluteUrl}/_layouts/15/images/CancelGlyph.16x16x32.png?rev=23`;
  public editImgUrl: string = `${_spPageContextInfo.webAbsoluteUrl}/_layouts/15/images/edititem.gif?rev=23`;
  public deleteImgUrl: string = `${_spPageContextInfo.webAbsoluteUrl}/_layouts/15/images/delitem.gif?rev=23`;
  public saveImgUrl: string = `${_spPageContextInfo.webAbsoluteUrl}/_layouts/15/images/saveitem.gif?rev=23`;
